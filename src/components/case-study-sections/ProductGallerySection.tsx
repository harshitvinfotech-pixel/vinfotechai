        ...
        <div className="relative flex items-center justify-center gap-3 sm:gap-6 lg:gap-10">
          ...
          <div className="relative w-full">
            <div className="flex items-center justify-center gap-3 sm:gap-6 lg:gap-10">
              ...
              <div ref={galleryRef} className={`relative flex-1 max-w-[calc(50vw-2rem)] sm:max-w-6xl transition-all duration-1000 ${galleryVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}>
                <div
