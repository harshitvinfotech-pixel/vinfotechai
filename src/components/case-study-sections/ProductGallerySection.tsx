  ...
  return (
    <section ref={sectionRef} className="py-12 sm:py-16 lg:py-20 bg-white dark:bg-gray-900 transition-colors duration-300">
      <div className="max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative flex items-center justify-center sm:gap-6 lg:gap-10">
          <button
            onClick={handlePrev}
          ...
          <div className="relative w-full max-w-full overflow-hidden">
            <div className="flex items-center justify-center sm:gap-6 lg:gap-10">
              <div
              ...
              <div ref={galleryRef} className={`relative w-full sm:flex-1 sm:max-w-6xl transition-all duration-1000 ${galleryVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}>
                <div
