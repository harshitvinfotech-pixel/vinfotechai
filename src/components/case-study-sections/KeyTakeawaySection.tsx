...
export default function KeyTakeawaySection({ takeawayText }: KeyTakeawaySectionProps) {
  ...
  return (
    <section className="py-12 sm:py-16 lg:py-20 bg-gray-50 dark:bg-[rgb(30,35,45)] transition-colors duration-300">
      <div className="max-w-4xl mx-auto px-6 sm:px-6 lg:px-8">
        <div ref={cardRef} className={`bg-white dark:bg-dark-bg rounded-2xl lg:rounded-3xl p-6 sm:p-10 lg:p-16 flex flex-col items-center text-center shadow-xl hover:shadow-2xl transition-all duration-1000 ${cardVisible ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-12 scale-95'}`}>
