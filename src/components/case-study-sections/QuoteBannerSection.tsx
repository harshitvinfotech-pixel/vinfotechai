...
export default function QuoteBannerSection({ quoteText, quoteAttribution }: QuoteBannerSectionProps) {
  ...
  return (
    <section className="py-16 sm:py-20" style={{ backgroundColor: '#00B46A' }}>
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center text-center">
          ...
          <blockquote className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-6 leading-relaxed">
            "{quoteText}"
          </blockquote>
