    ...
    <section className="mb-16 relative">
      ...
      {quote && (
        <div className="absolute -bottom-8 left-1/2 -translate-x-1/2 z-10 w-full max-w-3xl px-4">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border-2 border-gray-200 dark:border-gray-700 p-6">
            <div className="flex items-start gap-4">
              <div className="flex-shrink-0 w-12 h-12 rounded-full bg-[#00B46A] flex items-center justify-center">
