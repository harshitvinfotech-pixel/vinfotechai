  ...
  return (
    <div className="relative mx-auto w-full max-w-sm">
      <div className="relative bg-gray-900 rounded-[3rem] p-3 shadow-2xl border-8 border-gray-800">
        ...
        <div className="bg-white dark:bg-[rgb(30,35,45)] rounded-[2.5rem] overflow-hidden shadow-inner">
          ...
          <div className="h-[500px] overflow-y-auto bg-gray-50 dark:bg-dark-bg p-4 space-y-3">
                ...
                <div
                  className={`max-w-[80%] rounded-2xl px-4 py-3 ${
                    message.role === 'user'
                      ...
                      : 'bg-white dark:bg-[rgb(40,45,55)] text-gray-800 dark:text-gray-200 shadow-sm rounded-bl-sm'
                  }`}
                >
          ...
          <div className="bg-white dark:bg-[rgb(30,35,45)] border-t border-gray-200 dark:border-gray-700 px-4 py-3 flex items-center gap-2">
            <input
              type="text"
              placeholder="Type a message..."
              className="flex-1 bg-gray-100 dark:bg-gray-700 dark:text-white rounded-full px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500"
              disabled
            />
