...
export default function CTA({ onQuoteClick }: CTAProps) {
  ...
  return (
    <section ref={sectionRef} className="py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 bg-gray-200 dark:bg-gray-900 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto relative">
        <div className="relative">
          <div className="relative bg-white dark:bg-gray-800 rounded-2xl sm:rounded-3xl border border-gray-300 dark:border-gray-700 overflow-hidden shadow-lg">
            ...
            <div className="relative px-5 py-10 sm:px-10 sm:py-14 md:px-12 md:py-16 text-center">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 dark:text-white mb-4 sm:mb-6 tracking-tight leading-[1.2]">
                Start a 10-Day AI Sprint
              </h2>

              <div className="max-w-3xl mx-auto mb-8 sm:mb-10">
                <p className="text-lg sm:text-lg md:text-xl lg:text-2xl text-gray-700 dark:text-gray-300 mb-3 sm:mb-4 leading-relaxed">
                  Bring us one workflow. We'll ship something real.
                </p>
                <p className="text-base sm:text-lg md:text-xl lg:text-2xl font-medium" style={{ color: '#666666' }}>
