  ...
  const services = [
    {
      ...
      image: '/ai-unstructured-text-data.jpg',
    },
    {
      id: 'computer-vision',
      ...
      image: '/ai-computer-vision-visual-data.jpg?auto=compress&cs=tinysrgb&w=1200',
    },
    {
      id: 'ai-agents',
          ...
          {services.map((service, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  <div className={`relative h-[200px] sm:h-[450px] lg:h-full overflow-hidden transition-all duration-1000 ${isVisible ? 'scale-100 opacity-100' : 'scale-95 opacity-0'}`}
                    style={{
                    ...
                    <div className="space-y-4 sm:space-y-6 lg:space-y-7 w-full py-2">
                      ...
                      {service.highlights.map((highlight, highlightIndex) => (
                        ...
                        >
                          ...
                          <p
                            className="text-base sm:text-lg lg:text-xl text-gray-700 dark:text-gray-300 leading-relaxed text-left transition-all duration-300 group-hover/highlight:text-[#00B46A] group-hover/highlight:translate-x-1"
