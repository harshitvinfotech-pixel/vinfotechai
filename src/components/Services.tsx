          ...
          {services.map((service, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  <div className={`relative h-[460px] sm:h-[400px] lg:h-full overflow-hidden transition-all duration-1000 ${isVisible ? 'scale-100 opacity-100' : 'scale-95 opacity-0'}`}
                    style={{
                  ...
                  <div className="bg-gray-50 dark:bg-black p-6 sm:p-8 lg:p-10 flex items-start min-h-[400px] sm:min-h-[450px] lg:min-h-[400px] overflow-y-auto sm:overflow-y-visible">
