  ...
  const services = [
    {
      ...
      image: '/ai-unstructured-text-data.jpg?auto=compress&cs=tinysrgb&w=1200',
    },
    {
      id: 'computer-vision',
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <div className="bg-gray-50 dark:bg-black p-6 sm:p-8 lg:p-10 flex items-start min-h-[520px] sm:min-h-[580px] lg:min-h-[580px]">
