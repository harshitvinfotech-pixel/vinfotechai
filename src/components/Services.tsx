            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <div className="bg-gray-50 dark:bg-black p-6 sm:p-8 lg:p-10 flex items-start min-h-[400px] sm:min-h-[450px] lg:min-h-[450px] overflow-y-auto sm:overflow-y-visible">
