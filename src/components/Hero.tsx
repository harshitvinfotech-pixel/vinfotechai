    ...
    <section className="flex flex-col justify-center items-center px-6 sm:px-6 md:px-8 lg:px-12 py-12 sm:py-16 md:py-20" style={{ minHeight: '80vh' }}>
        <div className="max-w-6xl mx-auto text-center w-full">
          <div className="flex flex-col items-center justify-center gap-4 sm:gap-5 md:gap-6 lg:gap-7">
            <h1 className="text-[28px] sm:text-3xl md:text-3xl lg:text-5xl xl:text-6xl font-bold leading-tight px-2 sm:px-6 max-w-[100%] sm:max-w-5xl md:max-w-6xl lg:max-w-7xl w-full">
            ...
            <p className="text-base sm:text-lg md:text-xl lg:text-xl font-normal text-white/90 animate-fade-in-up sm:px-6 leading-relaxed max-w-3xl mx-auto" style={{ animationDelay: '0.6s', animationFillMode: 'both' }}>
