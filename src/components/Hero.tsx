...
export default function Hero({ onQuoteClick }: HeroProps) {
  return (
    <section className="flex flex-col justify-center items-center px-6 sm:px-6 md:px-8 lg:px-12 py-12 sm:py-16 md:py-20 min-h-screen">
        <div className="max-w-6xl mx-auto text-center w-full">
          <div className="flex flex-col items-center justify-center gap-4 sm:gap-5 md:gap-6 lg:gap-7">
            <h1 className="text-4xl sm:text-5xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight px-2 sm:px-6 max-w-7xl w-full text-center">
            ...
            <p className="text-xl sm:text-2xl md:text-2xl lg:text-3xl font-normal text-gray-700 dark:text-white/90 animate-fade-in-up px-4 sm:px-6 leading-relaxed max-w-4xl mx-auto text-center" style={{ animationDelay: '0.6s', animationFillMode: 'both' }}>
