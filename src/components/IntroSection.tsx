  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto text-center relative z-10">
        ...
        <p className={`text-base sm:text-lg md:text-xl lg:text-2xl text-gray-700 dark:text-gray-300 leading-relaxed sm:leading-relaxed md:leading-relaxed transition-all duration-1000 sm:px-6 md:px-2 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{ transitionDelay: '200ms' }}>
