          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12 pb-12 sm:pb-16 md:pb-20 lg:items-start">
            <div className="lg:col-span-8">
              <div className="max-w-none">
                <div className="pt-4 px-4 sm:px-8 lg:px-12">
                  ...
                  <ReactMarkdown
                    ...
                    components={{
                      ...
                      ul: ({node, ...props}) => {
                        ...
                        return (
                          <ul
                            className={`text-[20px] text-gray-700 dark:text-gray-300 space-y-3 mb-[30px] pl-6 sm:pl-8 ${
                              isNested ? 'nested-bullet-list' : 'list-disc'
                            }`}
                            {...props}
                          />
                        );
