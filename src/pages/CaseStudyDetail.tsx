          ...
          <section className="mb-0 bg-gray-50 dark:bg-black py-12 sm:py-16">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="relative pt-8">
                <div className="bg-white rounded-t-2xl px-8 py-4 shadow-md" style={{ position: 'absolute', top: '-22px', left: '0', width: '200px', zIndex: 1, clipPath: 'polygon(0 0, 85% 0, 100% 100%, 0% 100%)', borderTopRightRadius: '62px' }}>
