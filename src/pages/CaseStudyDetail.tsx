...
export default function CaseStudyDetail() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-300">
      ...
      <div className="relative h-[60vh] min-h-[500px] bg-gray-100 dark:bg-gray-800 overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4 sm:px-6">
          <h1 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-gray-900 dark:text-white mb-4 sm:mb-6 max-w-5xl leading-tight px-2">
            {caseStudy.title}
          </h1>
          {(caseStudy.subtitle || caseStudy.hero_description) && (
            <p className="text-sm sm:text-lg md:text-xl lg:text-2xl text-gray-800 dark:text-gray-200 max-w-4xl leading-relaxed px-2">
              {caseStudy.subtitle || caseStudy.hero_description}
            </p>
          )}
        </div>
      ...
      <main className="pb-12 sm:pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8 sm:mt-16 relative z-10">
          ...
          <section className="mb-12 sm:mb-20 bg-gray-50 dark:bg-black -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
          ...
          <section className="mb-12 sm:mb-20 bg-gray-100 dark:bg-gray-800 -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
            <div className="max-w-7xl mx-auto">
          ...
          <section className="mb-12 sm:mb-20">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-12 lg:gap-16 items-center">
              ...
              <div className="order-2">
                <div className="w-full max-w-md mx-auto" style={{ height: '600px' }}>
          ...
          <section className="mb-12 sm:mb-20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
              <div className="bg-white dark:bg-gray-900 rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-xl border border-gray-200 dark:border-gray-700 max-h-[600px] overflow-y-auto">
                <ApproachTimeline />
              </div>
          ...
          <section className="mb-12 sm:mb-20">
            <div className="rounded-2xl sm:rounded-3xl py-8 sm:py-10 md:py-12 px-4 sm:px-6 md:px-8 shadow-2xl mb-6 sm:mb-8 relative" style={{ background: 'linear-gradient(to right, #00B46A, #00B46A, #00A060)' }}>
              <div className="absolute top-8 right-8">
                <span className="inline-block px-4 py-2 bg-white/20 backdrop-blur-sm rounded-lg text-white font-semibold text-sm">
                  Impact
                </span>
              </div>
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 sm:gap-6 lg:gap-4 mt-8">
          ...
          <section className="mb-12 sm:mb-20">
            ...
            <div className="overflow-x-auto pb-4">
              <div className="flex gap-4 min-w-max">
                ...
                <TechStackCard icon={Search} name="pgvector" category="Retrieval" />
                <TechStackCard icon={Search} name="ElasticSearch" category="Retrieval" />
                <TechStackCard icon={Layout} name="React + NextJS" category="Frontend" />
                <TechStackCard icon={Layout} name="Tailwind" category="Frontend" />
                <TechStackCard icon={Server} name="AWS ECS" category="Infrastructure" />
                <TechStackCard icon={Server} name="PostgreSQL" category="Database" />
              </div>
            </div>
          </section>
...
function TechStackCard({ icon: Icon, name, category }: TechStackCardProps) {
  return (
    <div className="flex-shrink-0 w-48 bg-white dark:bg-gray-800 rounded-xl p-4 shadow-lg border border-gray-200 dark:border-gray-700 hover:border-emerald-500 dark:hover:border-emerald-400 transition-all duration-300 hover:shadow-xl">
      <div className="flex flex-col items-center text-center">
